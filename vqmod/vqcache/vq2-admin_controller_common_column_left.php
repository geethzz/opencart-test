		...
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($report) {
				...
				$data['menus'][] = array(
					'id'       => 'menu-pushassist',
					'icon'	   => 'fa fa-bell', 
					'name'	   => $this->language->get('text_pushassist'),
					'href'     => '',
					'children' => array(
							      array(
								      'name'=> $this->language->get('text_dashboard'),
								      'href'  => $this->url->link('pushassist/dashboard', 'user_token=' . $this->session->data['user_token'], true),
								      'children' => array()		
							      ),
							      array(
								      'name'=> $this->language->get('text_notifications'),
								      'href'  => $this->url->link('pushassist/notifications', 'user_token=' . $this->session->data['user_token'], true),
								      'children' => array()		
							      ),
							      array(
								      'name'=> $this->language->get('text_send_notification'),
								      'href'  => $this->url->link('pushassist/sendnotification', 'user_token=' . $this->session->data['user_token'], true),
								      'children' => array()		
							      ),
							      array(
								      'name'=> $this->language->get('text_segments'),
								      'href'  => $this->url->link('pushassist/segments', 'user_token=' . $this->session->data['user_token'], true),
								      'children' => array()		
							      ),
							       array(
								      'name'=> $this->language->get('text_create_segment'),
								      'href'  => $this->url->link('pushassist/createsegment', 'user_token=' . $this->session->data['user_token'], true),
								      'children' => array()		
							      ),
							       array(
								      'name'=> $this->language->get('text_subscribers'),
								      'href'  => $this->url->link('pushassist/subscribers', 'user_token=' . $this->session->data['user_token'], true),
								      'children' => array()		
							      ),
							      array(
								      'name'=> $this->language->get('text_settings'),
								      'href'  => $this->url->link('pushassist/settings', 'user_token=' . $this->session->data['user_token'], true),
								      'children' => array()		
							      ),
							       array(
								      'name'=> $this->language->get('text_campaigns'),
								      'href'  => $this->url->link('pushassist/campaigns', 'user_token=' . $this->session->data['user_token'], true),
								      'children' => array()		
							      )
							)
				);	
